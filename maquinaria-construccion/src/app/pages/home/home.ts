...
export class HomeComponent {
  hoveredServicioIndex: number | null = 0;
  ...
  setHighlightedService(index: number) {
    this.hoveredServicioIndex = index;
  }

  clearHighlightedService() {
    this.hoveredServicioIndex = null;
  }

  get highlightedService() {
    return this.hoveredServicioIndex === null ? this.servicios[0] : this.servicios[this.hoveredServicioIndex];
  }
}