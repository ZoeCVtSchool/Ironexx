...
// Este archivo debe ser IDENTICO al de mobile_app/lib/ble_constants.dart.
//
...
class BleConstants {
  ...
  // Device name (no se usa en el advertising: localName + UUID de 128 bits
  // supera el limite de 31 bytes del advertising BLE legacy y falla en
  // silencio)
  static const String DEVICE_NAME = 'Ironexx Wearable';

  // Umbrales criticos (deben coincidir con mobile_app/lib/ble_constants.dart)
